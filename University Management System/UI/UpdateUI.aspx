<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="UpdateUI.aspx.cs" Inherits="University_Management_System.UI.UpdateUI1" %>
        ...
        <div>
            <table>
                <tr>
                    ...
                    <td class="auto-style1">
                    <asp:TextBox ID="regNoTextBox" runat="server" ReadOnly="True"></asp:TextBox>
                    </td>
                </tr>
